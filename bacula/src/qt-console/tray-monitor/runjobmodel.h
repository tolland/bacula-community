...
#ifndef RUNJOBMODEL_H
#define RUNJOBMODEL_H
...
/*
   RunJobModel - contains the director that the App is connected with.
...
*/
class RunJobModel : public QObject
{
    Q_OBJECT
...
public:
    explicit RunJobModel(QObject *parent = nullptr);
    ~RunJobModel();
